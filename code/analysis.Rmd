...
# Choice made = Reward offered + Probability + EV + Trial number + FMT + FMT x EV 
# Tonic FMT
mi_choice1_tonictheta_interact <- glmer(choice ~ offerReward * offerProbability + trial + 
                                          fcz_choice_theta_entire4sChoiceC + fcz_choice_theta_entire4sChoiceC:offerReward:offerProbability +
                                           (1 + offerReward * offerProbability + trial + 
                                              fcz_choice_theta_entire4sChoiceC + fcz_choice_theta_entire4sChoiceC:offerReward:offerProbability || subject), 
                                       data = dt1, family = "binomial", 
                                       control = glmerControl(optimizer ='bobyqa', optCtrl = list(maxfun = 2e4)))
...
mi_rewp_binary <- lmer(rewp_FCz ~ choiceC + offerProbability + outcomeRewardBinary + offerProbability:outcomeRewardBinary + Pz_p3C + trial + (1 + choiceC + offerProbability + outcomeRewardBinary + offerProbability:outcomeRewardBinary + Pz_p3C + trial || subject), data = dt1, 
               control = lmerControl(optimizer ='bobyqa', optCtrl = list(maxfun = 2e4)))
